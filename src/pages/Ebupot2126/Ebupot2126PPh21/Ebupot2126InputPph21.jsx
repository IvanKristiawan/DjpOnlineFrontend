  ...
  const hitungPphPasal21 = async () => {
    ...
    if (bupot2126SkemaPenghitungan) {
      if (skemaPenghitungan === "Gross") {
        ...
        let hitungPphPasal21 = parseInt(
          (hitungDpp * findTer.data.tarifPersen) / 100
        );
        // console.log("hitungPphPasal21");
        // console.log(hitungPphPasal21);
        setPphPasal21(hitungPphPasal21);
        ...
        let jumlahPenghasilanIterasi2 =
          parseInt(jumlahPenghasilan) + hitungPphPasal21;
        ...
        let hitungPphPasal21Iterasi2 = parseInt(
          (jumlahPenghasilan * (findTerIterasi2.data.tarifPersen / 100)) /
            (100 / 100 - findTerIterasi2.data.tarifPersen / 100)
        );
        // console.log("hitungPphPasal21Iterasi2");
        // console.log(hitungPphPasal21Iterasi2);
        setPphPasal21(hitungPphPasal21Iterasi2);

        let hitungDppIterasi2 =
          parseInt(jumlahPenghasilan) + parseInt(hitungPphPasal21Iterasi2);
              ...
              <div>
                ...
                <div>
                  <div style={titleContainer}>
                    <div style={titleWrapper}>BULANAN & FINAL/TIDAK FINAL</div>
                  </div>
                        ...
                        {bupot2126DasarPengenaanPajakBebasInput ? (
                          <NumericFormat
                            ...
                            onValueChange={(values) => {
                              ...
                              let hitungPphPasal21 = (tempValues * tarif) / 100;
                              setPphPasal21(hitungPphPasal21);
                            }}
                          />
                        ) : (
                          ...
                          <InputGroup>
                            <NumericFormat
                              ...
                              onValueChange={(values) => {
                                ...
                                setTarif(tempValues);
                                let hitungPphPasal21 = (dpp * tempValues) / 100;
                                setPphPasal21(hitungPphPasal21);
                              }}
                            />
                      ...
                      <Col sm="7">
                        <Autocomplete
                          ...
                          renderInput={(params) => (
                            <TextField
                              size="small"
                              error={validated && bertindakSebagai.length === 0}
                              helperText={
                                validated &&
        ...
        <div style={{ padding: "30px" }}>
          ...
          >
            <Button
              ...
              style={{ paddingTop: "10px" }}
              onClick={() => {
                navigate("/ebupot2126/daftarPph21");
              }}
            >
              Tidak
            </Button>
