...
function Ebupot2126InputPph21Tahunan() {
  ...
  const handleKodeObjekPajakChange = (e) => {
    setKodeObjekPajak(e.target.value);
    findObjekPajakData(e.target.value);
  };
  ...
  const saveEbupot2126InputPph21Tahunan = async (e) => {
    e.preventDefault();
    e.stopPropagation();
    ...
    if (handlingInput) {
      try {
        setOpenSearchIdentitasWp(true);
        let savedEBupot2126Pph21Tahunan = await axios.post(
          `${tempUrl}/saveEBupot2126Pph21Tahunan`,
          {
            userId: user.id,
          ...
          <Card style={{ marginTop: "20px" }}>
            ...
            <Card.Body>
              <Form
                noValidate
                validated={validated}
                onSubmit={saveEbupot2126InputPph21Tahunan}
              >
                <div>
                  <div
                    style={{
                          ...
                          <Col sm="4" className="mt-2">
                            <Autocomplete
                              ...
                              onInputChange={(e, value) => {
                                setJumlahTanggunganKeluarga(value);
                              }}
                        ...
                        >
                          ...
                          <Col sm="8">
                            <Form.Control
                              ...
                              value={namaJabatan}
                              onChange={(e) => {
                                setNamaJabatan(e.target.value.toUpperCase());
                              }}
                            />
                            <Form.Control.Feedback type="invalid">
                              Kolom ini diperlukan.
                        ...
                        >
                          ...
                          <Col sm="8">
                            <Autocomplete
                              ...
                              value={namaNegara}
                              disabled={!isStatusKaryawanAsing && true}
                            />
                          </Col>
                        </Form.Group>
                      </div>
                        ...
                        <Col sm="8" className="mt-2">
                          <div style={inputRadioWrapper}>
                            <Form.Check
                              ...
                              onChange={handleKodeObjekPajakChange}
                              style={{ cursor: "pointer" }}
                            />
                            <Form.Check
                              type="radio"
                        ...
                        <Col sm="5">
                          ...
                          <Autocomplete
                            ...
                            onInputChange={(e, value) => {
                              ...
                              setBulanPajakAwal("01");
                              setBulanPajakAkhir("11");
                            }}
        ...
        <div style={{ padding: "30px" }}>
          ...
          >
            ...
            <button
              ...
              onClick={savedEbupot2126InputPph21Tahunan}
            >
              Ya
            </button>
          </DialogActions>
...
export default Ebupot2126InputPph21Tahunan;
