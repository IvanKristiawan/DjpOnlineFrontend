...
const PetunjukPengisianComponent = () => {
  return (
    <div>
      <p>
        <b>Deskripsi Form:</b> Form ini digunakan untuk mendaftarkan data pihak
        yang berhak melakukan penandatangan Bukti Pemotongan dan SPT.
      </p>
      <p>Terdapat 2 tipe penandatangan sebagai berikut:</p>
      <ol>
        <li>Wakil Wajib Pajak(Pengurus)</li>
        <ul>
          <li>Untuk WP Badan: Masukkan NPWP/NIK Pengurus</li>
          <li>Untuk WP OP: Masukkan NPWP sendiri</li>
        </ul>
        <li>Kuasa</li>
      </ol>
      <p>
        Jangan lupa untuk mencentang status aktif/tidak aktif dari
        Penandatangan.
      </p>
    </div>
  );
...
function TampilPenandatangan() {
  ...
  return (
    <div>
      ...
      <MainMenuEbupotUnifikasi activeLink={"/pengaturan/penandatangan"} />
...
export default TampilPenandatangan;
